...
#ifndef ____x_ABI_CDesktopPet_CIMainWindow_FWD_DEFINED__
#define ____x_ABI_CDesktopPet_CIMainWindow_FWD_DEFINED__
namespace ABI {
    namespace DesktopPet {
        interface IMainWindow;
    } /* DesktopPet */
} /* ABI */
#define __x_ABI_CDesktopPet_CIMainWindow ABI::DesktopPet::IMainWindow

#endif // ____x_ABI_CDesktopPet_CIMainWindow_FWD_DEFINED__
...
/*
 *
 * Interface DesktopPet.IMainWindow
 *
 * Interface is a part of the implementation of type DesktopPet.MainWindow
 *
 *
 * The IID for this interface was automatically generated by MIDLRT.
 *
 * Interface IID generation seed: DesktopPet.IMainWindow:
 *
 *
 */
#if !defined(____x_ABI_CDesktopPet_CIMainWindow_INTERFACE_DEFINED__)
#define ____x_ABI_CDesktopPet_CIMainWindow_INTERFACE_DEFINED__
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_DesktopPet_IMainWindow[] = L"DesktopPet.IMainWindow";
namespace ABI {
    namespace DesktopPet {
        /* [uuid("f4c127bb-9181-5fe5-ac40-bce57b00d12d"), version, object, exclusiveto] */
        MIDL_INTERFACE("f4c127bb-9181-5fe5-ac40-bce57b00d12d")
...
EXTERN_C const IID IID___x_ABI_CDesktopPet_CIMainWindow;
#endif /* !defined(____x_ABI_CDesktopPet_CIMainWindow_INTERFACE_DEFINED__) */


/*
 *
 * Class DesktopPet.MainWindow
 *
 * RuntimeClass can be activated.
 *
 * Class implements the following interfaces:
 *    DesktopPet.IMainWindow ** Default Interface **
 *
...
#ifndef RUNTIMECLASS_DesktopPet_MainWindow_DEFINED
#define RUNTIMECLASS_DesktopPet_MainWindow_DEFINED
extern const __declspec(selectany) _Null_terminated_ WCHAR RuntimeClass_DesktopPet_MainWindow[] = L"DesktopPet.MainWindow";
#endif
...
#ifndef ____x_ABI_CDesktopPet_CIMainWindow_FWD_DEFINED__
#define ____x_ABI_CDesktopPet_CIMainWindow_FWD_DEFINED__
typedef interface __x_ABI_CDesktopPet_CIMainWindow __x_ABI_CDesktopPet_CIMainWindow;
...
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_DesktopPet_IMainWindow[] = L"DesktopPet.IMainWindow";
/* [uuid("f4c127bb-9181-5fe5-ac40-bce57b00d12d"), version, object, exclusiveto] */
typedef struct __x_ABI_CDesktopPet_CIMainWindowVtbl
{
    BEGIN_INTERFACE
    HRESULT ( STDMETHODCALLTYPE *QueryInterface)(
    __RPC__in __x_ABI_CDesktopPet_CIMainWindow * This,
...
} __x_ABI_CDesktopPet_CIMainWindowVtbl;

interface __x_ABI_CDesktopPet_CIMainWindow
{
    CONST_VTBL struct __x_ABI_CDesktopPet_CIMainWindowVtbl *lpVtbl;
};

#ifdef COBJMACROS
#define __x_ABI_CDesktopPet_CIMainWindow_QueryInterface(This,riid,ppvObject) \
( (This)->lpVtbl->QueryInterface(This,riid,ppvObject) )

#define __x_ABI_CDesktopPet_CIMainWindow_AddRef(This) \
        ( (This)->lpVtbl->AddRef(This) )

#define __x_ABI_CDesktopPet_CIMainWindow_Release(This) \
        ( (This)->lpVtbl->Release(This) )

#define __x_ABI_CDesktopPet_CIMainWindow_GetIids(This,iidCount,iids) \
        ( (This)->lpVtbl->GetIids(This,iidCount,iids) )

#define __x_ABI_CDesktopPet_CIMainWindow_GetRuntimeClassName(This,className) \
        ( (This)->lpVtbl->GetRuntimeClassName(This,className) )

#define __x_ABI_CDesktopPet_CIMainWindow_GetTrustLevel(This,trustLevel) \
